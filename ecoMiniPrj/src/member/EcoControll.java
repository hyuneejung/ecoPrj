...
public class EcoControll {
   ...
   public EcoDto login(EcoDto data) {
      ...
      // SQL 실행 --?
      String sql = "SELECT E.NO, E.ID, E.NAME, E.NICK, E.GENDER, E.PHONE, B.NAME , E.ACCOUNT, E.POINT, E.ADDEDPOINT, E.ENROLL_DATE, R.RANK\r\n"
      		+ "FROM ECO_MEMBER E\r\n"
      		+ "JOIN BANKCODE B ON E.BANKNO = B.BANKNO\r\n"
      		+ "JOIN BANKSYS R ON E.RANKNO = R.NO\r\n"
      ...
      try {
         ...
         if (rs.next()) {
        	 String ecoid = rs.getString("ID");
        	   ...
        	   String bankNo = rs.getString("NAME_1");
