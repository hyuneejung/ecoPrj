...
public class EcoDto {
	...
	public EcoDto(String id, String pwd, String name, String nick, String gender, String phone, String bankNo,
	...
	public String toString() {
		return "EcoDto [id=" + id + ", pwd=" + pwd + ", name=" + name + ", nick=" + nick + ", gender=" + gender
				+ ", phone=" + phone + ", bankNo=" + bankNo + ", account=" + account + ", point=" + point
				+ ", addedPoint=" + addedPoint + ", enroll_date=" + enroll_date + ", rank=" + rank + ", quit_yn="
				+ quit_yn + "]";
	}
}
